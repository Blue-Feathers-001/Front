  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-24 glass-card-solid p-10 rounded-2xl animate-fadeInUp text-center">
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-primary-500 to-primary-700 w-20 h-20 rounded-2xl flex items-center justify-center mb-6 shadow-lg mx-auto">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
              Help us improve your gym experience. Share your suggestions, compliments, or concerns with our team.
            </p>
            <Link
              href="/feedback"
              className="btn-primary inline-flex items-center justify-center"
